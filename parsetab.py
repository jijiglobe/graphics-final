...
_lr_productions = [
  ...
  ('statement -> SPHERE NUMBER NUMBER NUMBER NUMBER INT INT','statement',7,'p_statement_sphere','mdl.py',186),
  ('statement -> SPHERE NUMBER NUMBER NUMBER NUMBER','statement',5,'p_statement_sphere','mdl.py',187),
  ('statement -> TORUS NUMBER NUMBER NUMBER NUMBER NUMBER INT INT','statement',8,'p_statement_torus','mdl.py',194),
  ('statement -> TORUS NUMBER NUMBER NUMBER NUMBER NUMBER','statement',6,'p_statement_torus','mdl.py',195),
  ('statement -> BOX NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',7,'p_statement_box','mdl.py',202),
  ('statement -> LINE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',7,'p_statement_line','mdl.py',206),
  ('statement -> CIRCLE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',8,'p_statement_circle','mdl.py',210),
  ('statement -> CIRCLE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',9,'p_statement_circle','mdl.py',211),
  ('statement -> BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',14,'p_statement_curve','mdl.py',221),
  ('statement -> BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',13,'p_statement_curve','mdl.py',222),
  ('statement -> HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',14,'p_statement_curve','mdl.py',223),
  ('statement -> HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',13,'p_statement_curve','mdl.py',224),
  ('statement -> MOVE NUMBER NUMBER NUMBER SYMBOL','statement',5,'p_statement_move','mdl.py',231),
  ('statement -> MOVE NUMBER NUMBER NUMBER','statement',4,'p_statement_move','mdl.py',232),
  ('statement -> SCALE NUMBER NUMBER NUMBER SYMBOL','statement',5,'p_statement_scale','mdl.py',240),
  ('statement -> SCALE NUMBER NUMBER NUMBER','statement',4,'p_statement_scale','mdl.py',241),
  ('statement -> ROTATE XYZ NUMBER SYMBOL','statement',4,'p_statement_rotate','mdl.py',249),
  ('statement -> ROTATE XYZ NUMBER','statement',3,'p_statement_rotate','mdl.py',250),
  ('SYMBOL -> XYZ','SYMBOL',1,'p_SYMBOL','mdl.py',258),
  ('SYMBOL -> ID','SYMBOL',1,'p_SYMBOL','mdl.py',259),
  ('TEXT -> SYMBOL','TEXT',1,'p_TEXT','mdl.py',263),
  ('TEXT -> STRING','TEXT',1,'p_TEXT','mdl.py',264),
  ('NUMBER -> DOUBLE','NUMBER',1,'p_NUMBER','mdl.py',268),
  ('NUMBER -> INT','NUMBER',1,'p_NUMBER','mdl.py',269),
]
